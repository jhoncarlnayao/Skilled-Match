          ...
          <section class="space-y-4">
            <div class="flex flex-col sm:flex-row sm:justify-between px-6 py-5 border-b border-slate-100">
              <div>
                ...
                <p class="text-xs text-slate-500 mt-1">See the latest accounts registered on the platform</p>
              </div>
          ...
          <section class="space-y-4">
            <div class="flex flex-col sm:flex-row sm:justify-between px-6 py-5 border-b border-slate-100">
              <div>
                ...
                <p class="text-xs text-slate-500 mt-1">Monitor recently posted jobs and their current status</p>
              </div>
          ...
          <div>
            <div class="flex flex-col sm:flex-row sm:justify-between px-6 py-4">
              <div>
                ...
                <p class="text-xs text-slate-500 mt-1">Add a new trade quickly for your clients and workers</p>
              </div>
            </div>
          ...
          <div>
            <div class="flex items-center justify-between px-6 py-4">
              <div>
                ...
                <p class="text-xs text-slate-500 mt-1">
                  {{ $announcements->count() }} total posted
                </p>
              </div>
            ...
            <div class="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
              ...
              @forelse($announcements as $announcement)
                <div class="px-5 py-4 border-b border-slate-100 last:border-b-0 hover:bg-slate-50/50 transition-colors">
                  ...
                  <div class="flex items-start justify-between gap-2">
                    ...
                    <span class="text-[10px] text-slate-400 whitespace-nowrap pt-0.5">
                  ...
                  <div class="flex items-center gap-1.5 mt-2.5">
                    <div class="w-4 h-4 rounded-full bg-slate-200 flex items-center justify-center">
                      <iconify-icon icon="solar:user-linear" width="10" class="text-slate-500"></iconify-icon>
                    </div>
                    <span class="text-[11px] text-slate-400">
                      {{ $announcement->admin->first_name ?? 'Admin' }}
                      {{ $announcement->admin->last_name ?? '' }}
                    </span>
                    <span class="text-[11px] text-slate-300 mx-1">·</span>
                    <span class="text-[11px] text-slate-400">
              ...
              @empty
                <div class="px-5 py-10 text-center">
                  <div class="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center mx-auto mb-3">
                    <iconify-icon icon="solar:megaphone-linear" width="20" class="text-slate-400"></iconify-icon>
                  </div>
                  <p class="text-sm font-medium text-slate-500">No announcements yet</p>
                  <p class="text-xs text-slate-400 mt-1">Post one using the button above.</p>
                </div>
              @endforelse
