...
<head>
    ...
    <title>Join SkilledTrade | Client Registration</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .field-input:focus {
            ...
            background: #fff;
            box-shadow: 0 0 0 4px rgba(253,80,104,0.06);
        }
        ...
        .submit-btn {
            ...
            box-shadow: 0 8px 24px rgba(253,80,104,0.28);
            position: relative;
            overflow: hidden;
        }
...
<div class="page-wrapper">
    ...
    <aside class="left-panel">
        <div style="position: relative; z-index: 1;">
          ...
          <div class="brand-tag mb-10">
            ...
            <h2 style="font-size: 32px; font-weight: 800; line-height: 1.2; color: white; margin-bottom: 16px;">
                Hire the right<br>
    ...
    <div style="margin-bottom: 24px;">
            ...
            <div style="margin-bottom: 40px;">
                <p style="font-size: 12px; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: var(--brand); margin-bottom: 8px; font-family: 'Sora', sans-serif;">Get Started Free</p>
                <h1 style="font-size: 28px; font-weight: 800; color: #111827; margin-bottom: 8px;">Create your account</h1>
                <p style="font-size: 14px; color: #9ca3af; line-height: 1.6;">Fill in the details below to start hiring skilled professionals.</p>
            </div>
            ...
            <form method="POST" action="{{ route('client.register.submit') }}" enctype="multipart/form-data">
                ...
                <div class="field-group">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 14px; margin-bottom: 14px;">
                        <div>
                            ...
                            <input type="text" name="first_name" value="{{ old('first_name') }}" required placeholder="John" class="field-input">
                        </div>
                        <div>
                            <label class="field-label">Middle Name</label>
                            <input type="text" name="middle_name" value="{{ old('middle_name') }}" placeholder="Quincy" class="field-input">
                        </div>
                        <div>
                            <label class="field-label">Last Name <span style="color:var(--brand)">*</span></label>
                            <input type="text" name="last_name" value="{{ old('last_name') }}" required placeholder="Doe" class="field-input">
                        </div>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 14px;">
                        <div>
                            ...
                            <input type="date" name="birthdate" value="{{ old('birthdate') }}" class="field-input">
                        </div>
                        <div>
                ...
                <div class="field-group">
                    ...
                    <div style="margin-bottom: 14px;">
                        ...
                        <input type="text" name="username" value="{{ old('username') }}" required placeholder="johndoe123" class="field-input">
                    </div>
                ...
                <div class="field-group">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 14px; margin-bottom: 14px;">
                        <div>
                            ...
                            <input type="tel" name="phone" value="{{ old('phone') }}" required placeholder="+63 912 345 6789" class="field-input">
                        </div>
                        <div>
                            <label class="field-label">Email Address <span style="color:var(--brand)">*</span></label>
                            <input type="email" name="email" value="{{ old('email') }}" required placeholder="john@email.com" class="field-input">
                        </div>
                    </div>

                    <div style="display: grid; grid-template-columns: 2fr 1fr 1fr; gap: 14px;">
                        <div>
                            <label class="field-label">Street Address <span style="color:var(--brand)">*</span></label>
                            <input type="text" name="address" value="{{ old('address') }}" required placeholder="House No., Street" class="field-input">
                        </div>
                        <div>
                            <label class="field-label">City <span style="color:var(--brand)">*</span></label>
                            <input type="text" name="city" value="{{ old('city') }}" required placeholder="Davao City" class="field-input">
                        </div>
                        <div>
                            <label class="field-label">Postal Code <span style="color:var(--brand)">*</span></label>
                            <input type="text" name="postal_code" value="{{ old('postal_code') }}" required placeholder="8000" class="field-input">
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-top: 8px;">
                    ...
                    <p style="text-align: center; margin-top: 20px; font-size: 13px; color: #9ca3af;">
                        ...
                        <a href="{{ route('login') }}" style="color: var(--brand); font-weight: 600; text-decoration: none; margin-left: 4px;">Sign in</a>
                    </p>

                    <p style="text-align: center; margin-top: 16px; font-size: 11px; color: #d1d5db; line-height: 1.6;">
                        By creating an account, you agree to our
                        <a href="#" style="color: #9ca3af; text-decoration: underline;">Terms of Service</a> and
